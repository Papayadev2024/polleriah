...
class NewsletterSubscriberController extends Controller
{
    ...
    private function envioCorreoAdmin($data)
    {
        ...
        // $name = $data['full_name'];
        $name = 'Administrador';
        $mensaje = 'tienes un nuevo suscriptor - Pollería Huaillys';
    ...
    { 
        ...
        // $name = $data['full_name'];
        $name = 'Suscriptor';
        $mensaje = 'Gracias por suscribirte - Pollería Huaillys';
        $mail = EmailConfig::config($name, $mensaje);
        $appUrl = env('APP_URL');
                        ...
                        <tr>
                          <td>
                            <p
                              ...
                              "
                            >
                              Te mantendremos informado de nuestras ofertas y promociones.
                            </p>
                          </td>
                        </tr>
                        <tr>
